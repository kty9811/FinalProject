							...
							<table class="table table-bordered text-center"
								...
								<c:forEach items="${noticeList }" var="notice">
									<tr style="margin: 0; padding: 0; padding-top: 5px;">
										<td>${notice.nno }</td>
										<td id="boardTitle"
											style="text-align: left; max-width: 100px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; color:black;">
											<a
											href="javascript:OpenWindow('detail_parents.do?nno=${notice.nno }&from=list','상세보기',800,700);">
												<span class="col-sm-12" style="color: black;">${notice.title }</span>
										</a>
										</td>
