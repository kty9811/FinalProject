						...
						<div class="login-box" style="margin: 0 0 0 110px;">
							...
							<div class="card"
								...
								<div class="card-body login-card-body"
									style="background-color: rgb(255, 255, 255, 0.2);">
									<br />
									<p style="font-size: 25px;" class="login-box-msg">학부모 로그인</p>
		

							
									
									<br />
									<form action="login_parents" method="post">
										<input type="hidden" name="retUrl" value="${param.retUrl}">
										<div class="input-group mb-3">
											<input type="text" name="parents_id" class="form-control"
										...
										<div class="input-group mb-3">
											<input type="password" name="parents_pwd"
										...
										<div class="row">
											...
											<div class="col-6">
												<button type="button" onclick="location.href='parents/regist'" class="btn btn-primary btn-block"
													style="background-color: rgb(35, 55, 101); border-color: rgb(52, 73, 94);">회원가입</button>
											</div>
